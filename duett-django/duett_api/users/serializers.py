...
from duett_api.users.signals.handlers import new_provider_profile_notify
...
class CreateProviderProfileSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        provider_profile = ProviderProfile.objects.create(account=account_obj, **validated_data)
...
class UploadDocsPostSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        instance = UploadDocs.objects.create(provider_profile=provider_profile, **validated_data)
        return instance
...
class FileUploadSerializer(serializers.Serializer):
    files = serializers.ListField(child=serializers.FileField(allow_empty_file=False, use_url=False))
